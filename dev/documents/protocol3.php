...
<p>
	This version of the protocol extends the <a href="protocol.php">previous
...
<p>
	TP uses SSL for encrypted access to the server, no special extensions have been 
	added and client certificates are not used.
</p><p>
	This can easily be implemented by using the stunnel (http://www.stunnel.org/) 
	program in front of a normal unencrypted TP server. 
</p>

<h2>HTTPS Tunneling</h2>
<p>
...
<p>
	...
	respond with the correct HTTP headers to cause the proxy to not cache.
</p></p>
...
<ul>
	...
	<li>ASCII text is shown as normal</li>
	<li><i>Unicode text is shown as italics</i></li>
</ul>
